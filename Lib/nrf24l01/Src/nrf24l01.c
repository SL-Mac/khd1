...
#define NRF24L01_TX_PACKET_WIDTH		6							//发送数据包宽度，范围：1~32字节
...
void NRF24L01_Init(void)
{
  ...
  NRF24L01_W_MOSI(0);
	...
	NRF24L01_WriteReg(NRF24L01_RF_CH, 0x36);		//射频通道，频率为(2400 + 2)MHz = 2.402GHz
	NRF24L01_WriteReg(NRF24L01_RF_SETUP, 0x0F);	//射频设置，数据速率2Mbps，发射功率0dBm
...
/**
  ...
  */
uint8_t NRF24L01_Send(uint8_t *DataArray)
{
	uint8_t Status;
	uint8_t SendFlag;
	uint32_t Timeout;
	...
	NRF24L01_WriteTxPayload(DataArray, NRF24L01_TX_PACKET_WIDTH);
